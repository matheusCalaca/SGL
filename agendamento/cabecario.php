...
<head>
	...
	<?php include '../links/elementos.php'; ?>
		...
		<div class="mdl-layout__drawer">
			<div class="tituloDrawer mdl-layout-title">
				...
				<nav class="mdl-navigation">
					<a href="index.php" class="mdl-navigation__link mdl-button mdl-js-button mdl-js-ripple-effect">Agendamento</a>
					<a href="../funcionario/" class="mdl-navigation__link mdl-button mdl-js-button mdl-js-ripple-effect">Funcionario</a>
