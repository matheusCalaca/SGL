	...
	<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header mdl-layout--fixed-drawer">
		...
		<div class="mdl-layout__drawer">
				...
				<nav class="mdl-navigation">
					<a href="#" class="mdl-navigation__link mdl-button mdl-js-button mdl-js-ripple-effect">Agendamento</a>
					<a href="#" class="mdl-navigation__link mdl-button mdl-js-button mdl-js-ripple-effect">Funcionario</a>
					<a href="#" class="mdl-navigation__link mdl-button mdl-js-button mdl-js-ripple-effect">Produto</a>
				</nav>
			</div>	<!--Gaveta de menus-->
